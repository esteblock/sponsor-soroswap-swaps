...
async function main() {
  try {
    ...
    console.log('🚀 Starting EURC to USDC EXACT OUT swap...')
    console.log('📊 User wants to receive exactly 0.1 USDC for EURC')
    ...
    const quoteRequest = {
        ...
        amount: BigInt(1000000), // 0.1 USDC in stroops (7 decimals) - EXACT OUT
        tradeType: TradeType.EXACT_OUT,
        protocols: [SupportedProtocols.SDEX], // Only SDEX
